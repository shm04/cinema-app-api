...
movie1 = Movie.create(title: "Toy Story", description: "Una divertida aventura animada sobre juguetes que cobran vida y enfrentan desafíos mientras aprenden sobre amistad y lealtad.", duration: 180, genre: "Animación", cinema: cinema1)
movie2 = Movie.create(title: "Star Wars: Episodio III", description: "La caída de Anakin Skywalker hacia el lado oscuro y el surgimiento de Darth Vader en un épico capítulo galáctico.", duration: 140, genre: "Sci-Fi", cinema: cinema1)
movie3 = Movie.create(title: "Maléfica", description: "La historia jamás contada de la icónica villana, explorando su origen, traición y redención en un mundo mágico.", duration: 97, genre: "Fantasía", cinema: cinema1)
movie4 = Movie.create(title: "Buscando a Nemo", description: "Un pez payaso emprende un viaje épico por el océano para rescatar a su hijo perdido, lleno de humor y emoción.", duration: 100, genre: "Animación", cinema: cinema2)
movie5 = Movie.create(title: "El Señor de los Anillos: El Retorno del Rey", description: "La batalla final por la Tierra Media y el épico viaje de Frodo para destruir el Anillo Único.", duration: 201, genre: "Fantasía", cinema: cinema2)
movie6 = Movie.create(title: "Harry Potter y el Cáliz de Fuego", description: "Harry participa en un peligroso torneo mágico mientras enfrenta oscuros peligros y el regreso de Lord Voldemort.", duration: 157, genre: "Fantasía", cinema: cinema2)
